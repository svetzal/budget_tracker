...
def test_can_add_consultancy(empty_practice: CoachingPracticeFinance, first_consultancy_details: dict):
    AddConsultancy(empty_practice).execute(**first_consultancy_details)
    verify_model(empty_practice.consultancies)


def test_can_add_multiple_consultancies(empty_practice: CoachingPracticeFinance, first_consultancy_details: dict,
...
def test_fails_when_adding_duplicate_consultancy(empty_practice: CoachingPracticeFinance,
